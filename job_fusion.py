...
if __name__ == '__main__':
    ...
    indices = perm[:100]
    torch.save(indices, './model_outputs/indices_100_for_fusion_disposed.pt')
    ...
    with open(f'./model_outputs/rec_decoded_seq_list_3_100_disposed.json', 'w', encoding='utf8') as fp:  # maybe filtered_assembly_ids.json is a better name
